...
function Nav(authLevel, isAuth) {
  ...
  return (
    <Switch>
      ...
      />
      <Route exact path="/sweeptakes" component={Sweeptakes} />
      <Route exact path="/sweeptakes2" component={Sweeptakes2} />
      <Route exact path="/sweeptakes3" component={Sweeptakes3} />
      <Route exact path="/sweeptakes4" component={Sweeptakes4} />
