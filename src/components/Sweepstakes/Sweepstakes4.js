    ...
    >
      <div className="contentWrap">
        ...
        <div>
          ...
          <p className="SW2Text">
            Thank you so much for submission!
        ...
        <p className="SW2Text">Thank you for the referral! Good luck</p>

        <button
          className="referButton"
          type="button"
          onClick={() => history.push('/Sweepstakes3')}
        >
          Refer a friend+
        </button>
